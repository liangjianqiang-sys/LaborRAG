...
from app.core.generator.prompts import ANSWER_STYLE_RULES, RAG_GENERATE_PROMPT
from app.core.generator.helpers import format_docs, normalize_article
...
async def _check_retrieval_sufficiency(grader_llm, question: str, context: str) -> bool:
    ...
    if len(context) < 50:
        return False
    from app.core.generator.prompts import RETRIEVAL_EVALUATION_PROMPT
